...
// Re-export types for consumers. `export *` already surfaces the canonical
// names (Node, Edge, Context, FileRecord, …) from ./types; an earlier explicit
// re-export referenced legacy aliases (CodeNode/CodeEdge/…) that this vendored
// copy of ./types does not define, so it was removed.
export * from './types';
export type { QueryBuilder } from './db/queries';
export {
  getCodeGraphDir,
  isInitialized,
